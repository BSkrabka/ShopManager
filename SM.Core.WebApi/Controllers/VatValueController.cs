...
namespace SM.Core.WebApi.Controllers
{
    ...
    public class VatValueController : BaseController<VatValueRequest, VatValueResponse>
    {
        public VatValueController(IVatValueService vatValueService) : base(vatValueService)
        {
        }
    }
}
